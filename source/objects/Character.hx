...
class Character extends FlxSprite
{
	...
	**/
	...
	inline public function isAnimationNull():Bool
		return !isAnimateAtlas ? (animation.curAnim == null) : #if flxanimate (atlas.anim.curSymbol == null) #else true #end;

	inline public function getAnimationName():String
	{
		var name:String = '';
		@:privateAccess
		if(!isAnimationNull()) name = !isAnimateAtlas ? animation.curAnim.name : #if flxanimate atlas.anim.lastPlayedAnim #else name #end;
